<template>
  <div class="fastLogin">
    ...
    <van-dialog @confirm="confirm()" :style="{textAlign:'center'}" cancel-button-text="继续发布" confirm-button-text="巡查记录" v-model:show="state.show" title="标题" show-cancel-button>
  <img style="height:50px;text-align:center" src="//image-dev.3-e.cn/editor/9b05959f1655408294aa5b2aa5376711.png" />
   <p>发布成功</p>
</van-dialog>
  </div>
</template>

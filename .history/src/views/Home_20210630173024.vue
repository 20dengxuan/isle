...
export default {
  ...
  setup() {
    ...
    const state = reactive({
      card: [],
      data:[
         {title:computed(()=>i18n.global.t('menu.news')) ,dada:[]},
         {title:computed(()=>i18n.global.t('menu.spread')),dada:[]},
         {title:computed(()=>i18n.global.t('title.enterprises')),dada:[]},
         {title:computed(()=>i18n.global.t('menu.industry')) ,dada:[]}
     ]
    });
    ...
    async const hhhh = computed( ()=>{
 
     return await $apiCache({key:'getNewsList',type:2},{lang:lang,page:1,page_size:12})

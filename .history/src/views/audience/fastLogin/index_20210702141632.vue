<template>
  <div class="fastLogin">
    ...
    <van-form>
       ...
       <van-field :style="{border:'1px solid #696969',width:'150px'}" @click="state.isShowCountry = true" v-model="state.country" right-icon="arrow-down" />
      ...
      <p><span>*</span>邮箱</p>
       ...
       <!-- 更多需求 -->
       <p><span>*</span>更多需求</p>
       <van-field :style="{border:'1px solid red',height:'80px'}" required name="content"  v-model="form.content" ></van-field>

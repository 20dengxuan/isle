<template>
  <div>
    <van-img
      src="//image-dev.3-e.cn/editor/935b7ffce5b142a7beed8713c6b41682.png"
      height="11.5rem"
      width="100%"
    />
    <div class="center">
      <div class="register">
        <span
          ><van-icon size="0.75rem" name="friends" /> 观众登记
          <van-icon name="arrow"
        /></span>
        <span
          ><van-icon size="0.75rem" name="manager" /> 展商登记
          <van-icon name="arrow"
        /></span>
      </div>
      ...
      <div class="room">
        <top-title> 展品&展区 </top-title>
        <div>
          <div @click="toExhibitor(c.id)" v-for="(c, index) in state.card" :key="index">
            <van-img
              height="6.25rem"
              width="10.8125rem"
              radius="0.3125rem"

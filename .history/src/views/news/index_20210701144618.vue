...
export default {
  setup(){
    ...
    const onLoad = ()=>{
      state.page++
       $apiCache({key:'getNewsList'},{lang:store.state.lang,page:state.page,page_size:20}).then(res=>{
   ...
   const getpage = ()=>{
      $apiCache({key:'getNewsList'},{lang:store.state.lang,page:1,page_size:20}).then(res=>{
        console.log(res)

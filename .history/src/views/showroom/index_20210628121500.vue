          ...
          <div class="top">
            <p><span>
              <img src="data:image/png;base64," alt=""> 
               {{a.hall_name}}</span><span @click="changearea(index)" ><van-icon size="0.75rem" name="replay" /> 换一批</span></p>
            <p>{{a.region_name}}</p>
          </div>
          <div class="bottom">
               <div v-for="(l,index) in a.list?.items" :key='index' class="list">
                  {{l.title}}
               </div>
...
export default {
  ...
  setup() {
    ...
    const getExhibitArea = (lang) =>{
      $apiCache({key:'getExhibitArea',type:2},{lang:lang}).then(res=>{
       ...
       state.area.dada = state.area.data.map(item=>{
        ...
        $apiCache({key:'getExhibitFlow',type:2},{lang:lang,page:1,page_size:8,area_id:item.id}).then(res=>{
           item.list = res.data
         })
        })
    ...
    const changearea = (index) =>{
      console.log(index)
      state.area.data[index].page =  state.area.data[index].page++

<template>
  <div class="showroom">
    ...
    <div class="category">
        <div @click="toExhibits(c.id)" v-for="(c,index) in state.category" :key="index">
          <div><van-img :src="img[index]?.img" /></div>
          <p>hh{{store.state.lang === 'zh'?c.zh:c.en}}</p>
        </div>
    </div>
...
export default {
  ...
  setup() {
    ...
    const img = ref([
       ...
       {
         img:'https://m.isle.org.cn/img/online_showroom/LED@2x.png'
       },
       {
         img:'https://m.isle.org.cn/img/online_showroom/bigshow@2x.png'
       },
       {
         img:'https://m.isle.org.cn/img/online_showroom/more@2x.png'
       },
       {
         img:'https://m.isle.org.cn/img/online_showroom/audio@2x.png'
       },
       {
         img:'https://m.isle.org.cn/img/online_showroom/bigshow@2x.png'
       },
       {
         img:'https://m.isle.org.cn/img/online_showroom/dance@2x.png'
       },
       {
         img:'https://m.isle.org.cn/img/online_showroom/public@2x.png'
       },
       {
         img:'https://m.isle.org.cn/img/online_showroom/bigshow@2x.png'
       },
       {
         img:'https://m.isle.org.cn/img/online_showroom/Print@2x.png'
       },{
         img:'https://m.isle.org.cn/img/online_showroom/shebei@2x.png'
       },
       {
         img:'https://m.isle.org.cn/img/online_showroom/digital@2x.png'
       },

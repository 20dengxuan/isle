<template>
  <div class="poput">
    ...
    <div class="form">
     ...
     <div class="button">
         <van-button @click="toSerah()" :style="{color:'white',width:'150px',background:'#4279ff'}">搜索</van-button>
         <van-button @click="clear()"  :style="{color:'#4279ff',width:'150px',border:'1px solid #4279ff'}">清空</van-button>
      </div>

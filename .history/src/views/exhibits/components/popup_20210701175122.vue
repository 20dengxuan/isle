<template>
  <div class="poput">
    ...
    <div class="form">
      ...
      <div class="row">
           <van-field right-icon="arrow-down" :style="{width:'9.875rem', border:'0.0625rem solid #969696'}" placeholder="选择分类" @click="show.showCategory = true" readonly v-model="state.category" />
            ...
            <van-field right-icon="arrow-down" :style="{width:'9.875rem', border:'0.0625rem solid #969696'}" placeholder="选择分类" @click="show.showCategory_son = true" readonly v-model="state.category_id" />

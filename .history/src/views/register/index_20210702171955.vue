      ...
      <van-form @submit="onSubmit">
        ...
        >
          <template v-slot:label>
            <i style="font-size:1.25rem" class="iconfont icon-youxiang"></i>
          </template>
        </van-field>
        <van-field
        ...
        >
          ...
          <template v-slot:label>
             <i style="font-size:1.25rem" class="iconfont icon-yanzhengma"></i>
          </template>
        </van-field>
...
import { $api,$apiCache } from '../../assets/script/api-cache';
